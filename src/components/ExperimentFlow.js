  ...
  if (stage === 'instructions') {
    ...
    if (showInstructions) {
      ...
      const instructions = {
        ...
        steps: [
          "במשימה זו תראה סדרת ספרות ותצטרך לחזור עליה בסדר הפוך.",
          "כל ספרה תוצג בנפרד למשך שנייה אחת.",
          "לאחר מכן הקלד את הספרות בסדר הפוך - מהאחרונה לראשונה",
          "לחץ Enter או על כפתור 'שלח' כדי להמשיך.",
          currentCondition.withMusic ? "במהלך המשימה תנגן מוזיקת רקע." : "המשימה תתבצע בשקט.",
          isFirstTask ? 
            (currentCondition.withMusic ? 
              "המשימה תתחיל עם שני נסיונות לתרגול בשקט, ולאחר מכן תתחיל המוזיקה עם המשימה עצמה." :
